# Ethereum Classic Token Creation Tool

A simple frontend tool to create tokens on the Ethereum Classic (ETC) network using a backend API.
...
- Insert this project link https://github.com/BayHatter/Ethereum-Classic-Token-Creation-Tool-Without-Coding.git
- And press deploy
- Congrats your Ethereum Classic Token Creation Tool installed on your vercel.com account
...
- Then donwload our code from https://github.com/BayHatter/Ethereum-Classic-Token-Creation-Tool-Without-Coding
- Upload into your Github repo.
- Edit the file public/config.json and insert your Ethereum Classic wallet address for receiving fees. Also set fee in ETC that you want to charge
